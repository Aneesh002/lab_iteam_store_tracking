...
import { 
  Loader2, ChevronRight, PackageMinus, AlertTriangle, Check, ArrowLeft, FlaskConical 
} from 'lucide-react'
    ...
    <div className="max-w-2xl mx-auto">
                  ...
                  >
                    <div className="text-left">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        {isLow && !isOut && <span className="badge bg-yellow-100 text-yellow-700">Low Stock</span>}
                        {isOut && <span className="badge bg-red-100 text-red-700">Out of Stock</span>}
                      </div>
                    </div>
      ...
      {step === 4 && selectedReagent && (
        <div>
          ...
          <div className="card mb-4">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-14 h-14 bg-red-100 rounded-xl flex items-center justify-center">
                <PackageMinus className="w-7 h-7 text-red-600" />
              </div>
              <div>
          ...
          >
            {withdrawing ? <Loader2 className="w-5 h-5 animate-spin" /> : <Check className="w-5 h-5" />}
